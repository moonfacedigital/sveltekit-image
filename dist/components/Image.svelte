<script>import { page } from /* @vite-ignore */ '$app/stores';
...
const isExternalUrl = () => ['http://', 'https://', 'ftp://'].some(protocol => src.startsWith(protocol)) && !src.startsWith($page.url.origin);
var preconnectLink;
var dnsLink;
var preloadLink;
