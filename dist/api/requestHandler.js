...
import { defaultConfig } from '../../../../../../../../src/lib/api/constants/defaultConfig.js';
import { AVIF, JPEG, WEBP } from '../../../../../../../../src/lib/api/constants/mimeTypes.js';
import { detectContentType } from '../../../../../../../../src/lib/api/functions/detectContentType.js';
import { getCacheKey } from '../../../../../../../../src/lib/api/functions/getCacheKey.js';
import { getExtension } from '../../../../../../../../src/lib/api/functions/getExtension.js';
import { getHash } from '../../../../../../../../src/lib/api/functions/getHash.js';
import { getMaxAge } from '../../../../../../../../src/lib/api/functions/getMaxAge.js';
import { getSupportedMimeType } from '../../../../../../../../src/lib/api/functions/getSupportedMimeType.js';
import { optimizeImage } from '../../../../../../../../src/lib/api/functions/optimizeImage.js';
import { readImageFileSystem } from '../../../../../../../../src/lib/api/functions/readImageFileSystem.js';
import { sendResponse } from '../../../../../../../../src/lib/api/functions/sendResponse.js';
import { writeImageToFileSystem } from '../../../../../../../../src/lib/api/functions/writeImageToFileSystem.js';
import { vectorTypes } from '../../../../../../../../src/lib/api/constants/vectorTypes.js';
import { animateableTypes } from '../../../../../../../../src/lib/api/constants/animateableTypes.js';
